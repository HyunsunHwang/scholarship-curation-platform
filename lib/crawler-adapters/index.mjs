...
export async function fetchCauPortalList(source, options = {}) {
  ...
  const apiAccept = cleanText(adapterConfig.apiAccept) || "application/json";
  const jsonContentTypePolicy = cleanText(adapterConfig.jsonContentTypePolicy) || "strict";
  const requiredListPath = cleanText(adapterConfig.requiredListPath) || "data.list";
