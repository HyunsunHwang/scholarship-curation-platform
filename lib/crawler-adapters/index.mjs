...
export async function fetchCauPortalList(source, options = {}) {
  ...
  const adapterConfig = source.adapterConfig ?? {};
  ...
  const apiUrl = renderAdapterUrlTemplate(
    readRequiredAdapterConfigString(adapterConfig, "requestUrlTemplate"),
    {},
  );
  const viewUrl = renderAdapterUrlTemplate(
    readRequiredAdapterConfigString(adapterConfig, "detailUrlTemplate"),
    {},
  );
