...
export function evaluateP0Audit({ corpus, adjudicationDecisions, overlay, recordsByCase }) {
  ...
  return {
    ...
    responsibility_boundary: {
      deterministic_fields: ["explicit application dates", "explicit provider/program labels", "explicit application URL", "simple amount", "conservative document classification", "lifecycle derivation from unambiguous start/deadline/timezone for a confirmed recruitment opportunity at fixed as_of"],
