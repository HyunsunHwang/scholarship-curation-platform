...
export {
  ...
  rebuildOperationalActionSummary,
  buildOperationalCrawlDiagnosticsCsv,
  validateOperationalCrawlDiagnostics,
} from "./operational-crawl-failure-analyzer.mjs";
export { loadPhase4ActionEvidence, injectPhase4ActionEvidence } from "./phase4-action-evidence-loader.mjs";
...
export {
  PHASE3_CLUSTER_EVIDENCE_STATUSES,
  PHASE3_CLUSTER_VERSION,
  buildPhase3RemediationClusters,
  classifyCandidateFingerprint,
  extractCandidateOrigin,
  normalizeCandidateLocator,
} from "./phase3-remediation-clustering.mjs";
