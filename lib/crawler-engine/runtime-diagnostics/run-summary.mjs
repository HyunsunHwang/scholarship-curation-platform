...
function sourceSummary(result) {
  return {
    ...
    transport_error_code: result.final_transport_error_code ?? result.transport_error_code ?? null,
    transport_error_category: result.final_transport_error_category ?? result.transport_error_category ?? null,
    transport_error_retryable: result.final_transport_error_retryable ?? result.transport_error_retryable ?? null,
