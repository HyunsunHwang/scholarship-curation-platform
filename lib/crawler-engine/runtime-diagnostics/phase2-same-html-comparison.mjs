...
export function buildPhase2SameHtmlComparison({
  ...
  const control = parserResult({ parser: executeControl, source: controlSource, capture: normalizedCapture, label: "control" });
  const treatment = parserResult({ parser: executeTreatment, source: treatmentSource, capture: normalizedCapture, label: "treatment" });
