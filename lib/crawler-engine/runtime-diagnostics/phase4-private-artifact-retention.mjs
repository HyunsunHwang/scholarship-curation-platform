...
export function validatePhase4PrivateArtifactRoot({ repositoryRoot, privateArtifactRoot, runIdentity, createRunDirectory = false } = {}) {
  ...
  return { configured: true, writable: true, git_ignored: internal ? true : null, create_only_supported: true, ...publish, run_directory_created: createRunDirectory, runDirectory };
}
