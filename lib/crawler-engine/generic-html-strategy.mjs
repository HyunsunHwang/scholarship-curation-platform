  ...
  return Object.freeze({
    ...
    parseDetail({ source, item, html }) {
      ...
      const detailTitleCandidates = [
        source.detailTitleSelector ? $(source.detailTitleSelector).first().text() : "",
      ...
      const detailIdentity = verifyOperationalDetailTitleIdentity(item.title, detailTitleCandidates);
