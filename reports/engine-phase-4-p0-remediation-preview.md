...
- The remediated entry point is `extractP0RemediatedCandidate` in `lib/engine-phase-4/p0-remediated-extractor.mjs`, version `1.0.0`.
...
Document kinds: correction_notice=2, general_guidance=1, recruitment_notice=18, result_announcement=3.
