...
SELECT
  ...
  'https://www.kfas.or.kr',
  '02-6310-7881',
  '1년간 커리큘럼 풀참여가 가능한 자만 지원 가능합니다. 어학연수, 교환학생, 취업, 군복무 등으로 인해 프로그램 참여가 어려운 경우 지원할 수 없습니다. 타 기관 장학금 및 장학 프로그램과 중복 수혜가 가능합니다. 선발 인원 등 세부 사항은 공고(www.kfas.or.kr)를 확인하세요.',
  3, '서류심사', '1차 면접', '최종발표',
  '2026-07-13', '2026-07-16', '2026-07-22',
  '주요 일정 · 1차 면접 7월 16일(대면 참석 필수)',
