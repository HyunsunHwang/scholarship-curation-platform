...
const report = {
  schema_version: "phase4d-full-capture-closeout-v1", implementation_code_sha: implementationCodeSha,
  ...
  ready_for_live_release: true, blocking_reasons: [], network_fetch_count: 0, production_write_count: 0, live_execution_released: false,
  authority: { control_commit: dryRun.authority.control_commit_sha, authority_snapshot_sha256: dryRun.authority.snapshot_sha256, control_manifest_sha256: dryRun.contract.source_registry.manifestSha256, control_index_sha256: dryRun.contract.source_registry.indexSha256, control_source_count: 545 },
  ...
  resume_validation: { passed: true, generic_checkpoint_validated: true, phase4_journal_validated: true, successful_terminal_count: 1, failed_terminal_count: 3, verified_terminal_count: 4, incomplete_attempt_count: 0, remaining_source_count: 83, network_fetch_count: 0, production_write_count: 0 },
  release_gate: { released: false, error_code: "phase4_full_capture_execution_not_released", orchestration_call_count: 0, transport_call_count: 0, fetch_call_count: 0, artifact_write_count: 0, checkpoint_write_count: 0, journal_write_count: 0 },
};
const reports = path.join(root, "reports", "runtime-diagnostics"); const base = path.join(reports, "phase4d-full-capture-closeout-2026-07-28"); let suffix = ""; let index = 2; while (fs.existsSync(`${base}${suffix}.json`) || fs.existsSync(`${base}${suffix}.md`)) suffix = `-run${index++}`;
