...
try {
  ...
  const index = createPhase4PrivateArtifactIndex({ runDirectory: privateRoot.runDirectory, indexMode: "preflight_probe", contractFingerprint: "0".repeat(64), codeSha: authority.control_commit_sha, authorityControlCommit: authority.control_commit_sha, sourceCount: 1, artifacts: [{ source_id: "one", capture_status: "preflight_probe", artifact_relative_path: "captures/one.json", artifact_sha256: hash, html_sha256: null, response_byte_count: 2, requested_url_hash: null, final_url_hash: null, capture_id: null, source_config_sha256: "0".repeat(64), transport_policy_fingerprint: "unavailable" }] }); assert.equal(index.index.artifact_count, 1); assert.throws(() => createPhase4PrivateArtifactIndex({ runDirectory: privateRoot.runDirectory, contractFingerprint: "0".repeat(64), codeSha: "x", authorityControlCommit: "x", sourceCount: 0, artifacts: [] }));
