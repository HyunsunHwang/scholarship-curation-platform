...
const artifacts = [["phase4c-readiness-closeout-2026-07-27-run2.json", `${JSON.stringify(result, null, 2)}\n`], ["phase4c-readiness-closeout-2026-07-27-run2.md", renderPhase4CCloseoutMarkdown(result)]];
