...
const inputPath =
  process.argv[2] ??
  String.raw`C:\Users\user\OneDrive - 고려대학교\문서\ExportBlock-b862e35b-98ce-46f8-8db8-549326d81099-Part-1\고려대 371628091bc080a3a5dbe524484a6c8a.csv`;
const outputPath = process.argv[3] ?? "data/notice-sources-korea.csv";
