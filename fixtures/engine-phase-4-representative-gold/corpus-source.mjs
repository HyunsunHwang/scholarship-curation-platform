...
export const relationGroups = [
  ...
  { group_id: "rg_hope_ladder_extension", relation_type: "deadline_extension_same_cycle", case_ids: ["p4c_003_hope_ladder_extension"], pairs: [{ left: "p4c_003_hope_ladder_extension", right: "p4c_003_hope_ladder_extension", relation: "deadline_extension_same_cycle", reason: "Notice title explicitly identifies an extended deadline; original notice URL not selected." }] },
  { group_id: "rg_gwangsan_extension", relation_type: "deadline_extension_same_cycle", case_ids: ["p4c_006_gwangsan_extension"], pairs: [{ left: "p4c_006_gwangsan_extension", right: "p4c_006_gwangsan_extension", relation: "deadline_extension_same_cycle", reason: "Notice explicitly states period extension; original notice URL not selected." }] },
  { group_id: "rg_national_work_result", relation_type: "result_notice_related_to_recruitment", case_ids: ["p4c_004_national_work_result", "p4c_002_national_second_round"], pairs: [{ left: "p4c_004_national_work_result", right: "p4c_002_national_second_round", relation: "clearly_different_program", reason: "Both are national schemes but work-study and national tuition aid differ." }] },
  { group_id: "rg_samsung_update", relation_type: "same_notice_repost_candidate", case_ids: ["p4c_018_uic_samsung_updated"], pairs: [{ left: "p4c_018_uic_samsung_updated", right: "p4c_018_uic_samsung_updated", relation: "review_required", reason: "The title records an update but no prior revision capture is retained." }] },
  { group_id: "rg_school_recommendation", relation_type: "school_recommendation_vs_foundation_original", case_ids: ["p4c_024_dean_recommendation_guidance", "p4c_023_russian_alumni_funds"], pairs: [{ left: "p4c_024_dean_recommendation_guidance", right: "p4c_023_russian_alumni_funds", relation: "review_required", reason: "Guidance may support many programs and cannot be automatically linked to this selected program." }] },
];
